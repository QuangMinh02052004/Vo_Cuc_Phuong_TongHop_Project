  ...
  try {
    ...
    for (const field of allowedFields) {
      if (body[field] !== undefined) {
        const dbField = ['timeSlotId', 'pickupMethod', 'pickupAddress', 'dropoffMethod', 'dropoffAddress', 'seatNumber', 'timeSlot', 'callStatus', 'roundTripGroupId'].includes(field)
          ? `"${field}"`
          : field;
